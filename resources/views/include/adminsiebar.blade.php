<aside class="app-sidebar">
    <div class="app-sidebar__user">
        <img class="app-sidebar__user-avatar" src="https://png.pngtree.com/png-vector/20190710/ourmid/pngtree-user-vector-avatar-png-image_1541962.jpg" style="width: 50px;height: 50px" alt="User Image">
        <div>
            <p class="app-sidebar__user-name">{{ \Session::get('admin_name') }}</p>
            <p class="app-sidebar__user-designation">Admin</p>
        </div>
    </div>
    <ul class="app-menu">
        <li>
            <a class="app-menu__item {{ (request()->segment(2) == '') ? 'active' : '' }}" href="{{ url('admin') }}">
                <i class="app-menu__icon fa fa-dashboard"></i>
                <span class="app-menu__label">Dashboard</span>
            </a>
        </li>
        <li>
            <a class="app-menu__item {{ (request()->segment(2) == 'memberarea') ? 'active' : '' }}" href="{{ route('memberarea') }}">
                <i class="app-menu__icon fa fa-dashboard"></i>
                <span class="app-menu__label">Member area</span>
            </a>
        </li>
